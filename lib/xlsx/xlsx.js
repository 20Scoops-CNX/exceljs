...
class XLSX {
  ...
  reconcile(model, options) {
    ...
    model.worksheetHash = null;
    model.worksheetRels = null;
    model.globalRels = null;
    model.sharedStrings = null;
    model.workbookRels = null;
    model.sheetDefs = null;
    model.styles = null;
    model.mediaIndex = null;
    model.drawings = null;
    model.drawingRels = null;
    model.vmlDrawings = null;
  }
